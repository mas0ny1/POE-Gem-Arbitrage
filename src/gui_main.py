...
class Ui_GemArbitrageGUI(object):
    def setupUi(self, GemArbitrageGUI):
        ...
        self.wokegemTable.setAlternatingRowColors(True)
        ...
        self.corruptTable.setAlternatingRowColors(True)
        ...
        self.font2Table.setGeometry(QtCore.QRect(10, 10, 1051, 621))
        self.font2Table.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.font2Table.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.font2Table.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.SizeAdjustPolicy.AdjustToContents)
        self.font2Table.setDragEnabled(True)
        self.font2Table.setAlternatingRowColors(True)
        self.font2Table.setVerticalScrollMode(QtWidgets.QAbstractItemView.ScrollMode.ScrollPerPixel)
        self.font2Table.setHorizontalScrollMode(QtWidgets.QAbstractItemView.ScrollMode.ScrollPerPixel)
        self.font2Table.setShowGrid(True)
        ...
        self.font1Table = QtWidgets.QTableView(parent=self.font1Tab)
        self.font1Table.setGeometry(QtCore.QRect(10, 10, 1051, 621))
        self.font1Table.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.font1Table.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.font1Table.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.SizeAdjustPolicy.AdjustToContents)
        self.font1Table.setDragEnabled(True)
        self.font1Table.setAlternatingRowColors(True)
        self.font1Table.setVerticalScrollMode(QtWidgets.QAbstractItemView.ScrollMode.ScrollPerPixel)
        self.font1Table.setHorizontalScrollMode(QtWidgets.QAbstractItemView.ScrollMode.ScrollPerPixel)
        self.font1Table.setShowGrid(True)
        ...
        self.actionVivid_Watcher_Tracker = QtGui.QAction(parent=GemArbitrageGUI)
        self.actionVivid_Watcher_Tracker.setObjectName("actionVivid_Watcher_Tracker")
        ...
        self.menuFile.addAction(self.actionVivid_Watcher_Tracker)
    ...
    def retranslateUi(self, GemArbitrageGUI):
        ...
        self.actionVivid_Watcher_Tracker.setText(_translate("GemArbitrageGUI", "Vivid Watcher Tracker"))
